...
import {
  ...
  LogOut, LogIn, ChevronRight, Menu, Plus, Brain, ArrowLeft
} from "lucide-react";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-3" style={{ borderBottom: "1px solid rgba(34,211,238,0.05)" }}>
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono" style={{ fontSize: "0.58rem", color: "rgba(34,211,238,0.8)", letterSpacing: "0.1em" }}>SYS:OK</span>
        </div>
      </div>
      ...
      {inCampaign ? (
        <div className="flex flex-col flex-1 overflow-y-auto">
          ...
          {campaignName && (
            <div className="px-4 py-3 mx-3 mb-1 rounded-lg" style={{ background: "rgba(34,211,238,0.08)", border: "1px solid rgba(34,211,238,0.22)" }}>
              <div className="font-mono" style={{ fontSize: "0.56rem", color: "rgba(34,211,238,0.65)", letterSpacing: "0.14em", textTransform: "uppercase", marginBottom: "4px" }}>
                Active Campaign
              </div>
          ...
          <nav className="px-3 py-4 space-y-0.5">
            <div className="px-2 mb-3" style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "0.58rem", fontWeight: 600, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(34,211,238,0.75)" }}>
              Campaign Tools
            </div>
                ...
                <Link key={item.href} href={item.href} onClick={() => setMobileOpen(false)}>
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: active ? "inset 3px 0 0 rgba(34,211,238,0.9)" : "none",
                    }}
                  >
                    <item.icon size={14} style={{ color: active ? "#22d3ee" : "rgba(100,116,139,0.7)", flexShrink: 0 }} />
                    <div className="flex-1 min-w-0">
                      <div className="font-mono truncate" style={{ color: active ? "#e2e8f0" : "#94a3b8", fontSize: "0.68rem", letterSpacing: "0.04em", fontWeight: active ? 600 : 400 }}>
                        {item.label}
                      </div>
                      <div className="font-mono truncate" style={{ fontSize: "0.56rem", color: active ? "rgba(34,211,238,0.65)" : "#64748b", letterSpacing: "0.06em" }}>
                        {item.sub}
                      </div>
                    </div>
        ...
        <div className="flex flex-col flex-1 overflow-y-auto">
          ...
          {campaigns && campaigns.length > 0 && (
            <div className="px-3 py-3" style={{ borderTop: "1px solid rgba(34,211,238,0.12)" }}>
              <div className="px-2 mb-2" style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "0.56rem", fontWeight: 600, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(34,211,238,0.75)" }}>
                Recent Campaigns
              </div>
                  ...
                  return (
                    <Link key={c.id} href={`/campaigns/${c.id}`} onClick={() => setMobileOpen(false)}>
                      ...
                      >
                        ...
                        <span className="font-mono truncate flex-1" style={{ fontSize: "0.62rem", color: active ? "#e2e8f0" : "#94a3b8" }}>
                          {c.name}
                        </span>
      ...
      {/* User */}
      <div className="px-3 pb-4 pt-3" style={{ borderTop: "1px solid rgba(34,211,238,0.12)" }}>
        {isAuthenticated && user ? (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="font-mono" style={{ fontSize: "0.56rem", color: "rgba(34,211,238,0.7)", letterSpacing: "0.08em" }}>
                CLEARANCE: FULL
              </div>
            </div>
            <button
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            {campaignName && (
              <>
                <ChevronRight size={12} style={{ color: "rgba(34,211,238,0.75)" }} />
